...
Welcome to the TextUtils project! This web application allows users to manipulate and analyze text in various ways. Built with React.js and styled using Tailwind CSS, TextUtils provides an intuitive interface for tasks such as counting words, changing case, and removing extra spaces.

[Video.webm](https://github.com/user-attachments/assets/2a9226a2-6f6e-4a81-bf2d-3c5cd8ca5eb1)

## Features
- Text Manipulation: Easily convert text to uppercase, lowercase, and capitalize sentences.
- Word and Character Count: Get real-time feedback on the number of words and characters in your input.
- Remove Extra Spaces: Clean up your text by removing unnecessary spaces.
- Responsive Design: Utilizes Tailwind CSS for a modern and adaptable layout across devices.

![Full-Screen-Capture](https://github.com/user-attachments/assets/1d1e9768-4249-4ca6-b0a0-c8e5547e3b88)
